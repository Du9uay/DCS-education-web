            ...
            <AnimatePresence>
              {!isVideoExpanded ? (
                ...
                <motion.div className="relative">
                  ...
                  >
                    {/* 渐变背景层 */}
                    <div className="absolute inset-0 bg-gradient-to-br from-[color:var(--primary-teal)] to-[color:var(--primary-teal-light)] opacity-80 rounded-full"></div>
                    ...
                    {/* 呼吸光环效果 */}
                    <motion.div
                      className="absolute -inset-1 rounded-full bg-gradient-to-r from-[color:var(--primary-teal)] to-[color:var(--primary-teal-light)] opacity-30 pointer-events-none"
                      animate={{
                        scale: [1, 1.05, 1],
                        opacity: [0.3, 0.5, 0.3]
                      }}
                ...
                >
                  ...
                  >
                    <button
                      onClick={handleTogglePlay}
                      className="w-8 h-8 bg-[color:var(--primary-teal)]/90 hover:bg-[color:var(--primary-teal)] rounded-full flex items-center justify-center text-white transition-all duration-200 shadow-lg transform hover:scale-105 active:scale-95"
                    >
                      {isVideoPlaying ? (
