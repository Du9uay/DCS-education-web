...
const CourseTestPage: React.FC = () => {
  ...
  const sequenceQuestions = useMemo(() => [
    {
      id: 'dcs_development_flow',
      question: '请将DCS系统发展历程按正确时间顺序排列：',
      items: [
        { id: 'intelligent_control', text: '智能化控制系统' },
        { id: 'direct_digital', text: '直接数字控制系统' },
        { id: 'distributed_control', text: '分布式控制系统' },
        { id: 'fieldbus_control', text: '现场总线控制系统' },
        { id: 'centralized_control', text: '集中控制系统' }
      ],
      correctOrder: ['direct_digital', 'centralized_control', 'distributed_control', 'fieldbus_control', 'intelligent_control']
    },
    {
      id: 'pid_control_flow',
      question: '请将PID控制的作用按重要性顺序排列：',
      items: [
        { id: 'derivative', text: '微分作用（超前控制）' },
        { id: 'integral', text: '积分作用（消除稳态误差）' },
        { id: 'proportional', text: '比例作用（基本控制）' }
      ],
      correctOrder: ['proportional', 'integral', 'derivative']
    }
  ], []);
  ...
  const matchingQuestions = useMemo(() => [
    {
      ...
      rightItems: [
        { id: 'r1', text: '控制调节阀开度0-100%' },
        { id: 'r2', text: '采集温度、压力等连续信号' },
        { id: 'r3', text: '检测设备运行/停止状态' },
        { id: 'r4', text: '控制泵的启动和停止' }
      ],
      correctMatches: {
        'l1': 'r2', // AI - 采集温度、压力等连续信号
        'l2': 'r1', // AO - 控制调节阀开度0-100%
        'l3': 'r3', // DI - 检测设备运行/停止状态
        'l4': 'r4'  // DO - 控制泵的启动和停止
      }
    }
  ], []);
  ...
  const multipleChoice = [
    ...
    {
      id: 'q3',
      question: 'PID控制中，哪个参数的作用是消除稳态误差？',
      options: [
        'A. 比例（P）',
        'B. 积分（I）',
        'C. 微分（D）',
    ...
    {
      id: 'q4',
      question: '4-20mA信号标准中，4mA代表的含义是？',
      options: [
        'A. 最大值',
        'B. 零点（最小值）',
        'C. 中间值',
                  ...
                  <div key={question.id} className="glass-effect rounded-2xl p-8">
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        <h4 className="text-accent-500 font-medium mb-4">信号类型</h4>
              ...
              <div className="text-center">
                ...
                <div className={`p-6 rounded-lg mb-6 ${
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    {score.score >= 80 ? 
                      '恭喜您！您已经很好地掌握了DCS控制系统的基础知识，可以进入实际操作训练阶段。' :
                      score.score >= 60 ?
                      '您对DCS基础知识有一定掌握，建议复习信号处理和控制原理等薄弱环节。' :
                      '建议您重新学习相关章节，特别关注DCS的基本概念、系统结构和信号类型。'
                    }
                  </p>
              </div>
              </div>
